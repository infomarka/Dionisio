...
# RailsAdmin config file. Generated on November 03, 2011 17:22
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Dionisio', 'Admin']
  ...
  # config.excluded_models << [ListaEmail, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [ListaEmail, User]
